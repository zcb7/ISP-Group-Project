...
<body>
    ...
    <div class="container" style="width: 85%; text-align: center;">
        <?php
			...
			{
				echo '<div>
					  <img src="logoIcon.png" alt="logo icon" width="300" height="300">
					  </div>';
				echo '<span style="color:red; border-style: double; font-size: 20pt; position: absolute; top: 50%; left: 50%; transform: translateX(-50%);">No Current Listings</span>';
				echo "Please click on \"List Product\" to start selling!";
			}
        ?>
